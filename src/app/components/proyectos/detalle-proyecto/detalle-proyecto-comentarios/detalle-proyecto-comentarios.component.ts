...
@Component({
  selector: 'app-detalle-proyecto-comentarios',
  templateUrl: './detalle-proyecto-comentarios.component.html',
  styleUrls: ['./detalle-proyecto-comentarios.component.css']
})
export class DetalleProyectoComentariosComponent {
