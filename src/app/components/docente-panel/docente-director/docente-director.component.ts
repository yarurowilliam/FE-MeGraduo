...
@Component({
  selector: 'app-docente-director',
  templateUrl: './docente-director.component.html',
  styleUrls: ['./docente-director.component.css'],
})
export class DocenteDirectorComponent implements OnInit {
  listProyectos: any[] = [];
  selectedProyect: any;
