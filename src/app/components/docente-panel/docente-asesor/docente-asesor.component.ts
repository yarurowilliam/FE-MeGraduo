...
@Component({
  selector: 'app-docente-asesor',
  templateUrl: './docente-asesor.component.html',
  styleUrls: ['./docente-asesor.component.css']
})
export class DocenteAsesorComponent {
  listProyectos: any[] = [];
  selectedProyect: any;
  searchText: string = '';
  orderBy: string = 'asc';
  sortKey: string = '';
  tittle1 = 'INFORMACIÓN GENERAL DE PROYECTOS ASIGNADOS';
  ...
  verProyectos() {
    if (this.isSelectedOption != 'misProyectos') {
      ...
      console.log("Id User del asesor: ", this.tokenIdUser);
